...
def _yf_analyst(ticker: str, prefetched=None) -> dict:
    try:
        ...
        fundamentals = {
            ...
            "sp500_52w_change": (lambda v: round(v * 100, 1) if v else None)(_safe_float(info, "SandP52WeekChange")),
            "stock_52w_change": (lambda v: round(v * 100, 1) if v else None)(_safe_float(info, "52WeekChange", "fiftyTwoWeekChange")),
